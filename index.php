...
if (isset($_POST['url'])) {
    ...
    $bdd = new PDO('mysql:host=localhost;dbname=my_bitly;charset=utf8', 'root', 'root');
...
<body>
    ...
    <section id="brands">
        ...
        <div class="container">
            ...
            <img src="./public/images/1.png" alt="1" class="picture">
            <img src="./public/images/2.png" alt="2" class="picture">
            <img src="./public/images/3.png" alt="3" class="picture">
            <img src="./public/images/4.png" alt="4" class="picture">
        </div>
    ...
    <!-- FOOTER -->
    <footer>
        <img src="./public/images/logo2.png" alt="logo" id="logo"><br>
        2018 © Bitly<br>
